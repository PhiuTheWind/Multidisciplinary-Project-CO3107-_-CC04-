...
function Header({ text, money, showLogout, isStudent }) {
    ...
    <header className={styles.header}>
      ...
      {showLogout && !isStudent && (
        <div className={styles.homebar}>
          <div className={styles.bar}>
            <button className={styles.button} onClick={() => navigate("/spso_homepage")}>
              HOME
            </button>
            <button
              className={styles.button}
              onClick={() => navigate("/spso_homepage/manage_printer")}
            >
              SINH VIÊN
            </button>
            <button
              className={styles.button}
              onClick={() => navigate("/spso_homepage/manage_cofig")}
            >
              GIÁ TIỀN
            </button>
            <button
              className={styles.button}
              onClick={() => navigate("/spso_homepage/view_stu_log")}
            >
              THÔNG TIN GỬI XE SINH VIÊN
            </button>
            <button
              className={styles.button}
              onClick={() => navigate("/spso_homepage/view_visitor_log")}
            >
              THÔNG TIN GỬI XE KHÁCH
            </button>
          </div>
        </div>
      )}
      {showLogout && isStudent && (
        <div className={styles.stuhomebar}>
          <div className={styles.bar}>
            <button className={styles.button} onClick={() => navigate("/student_homepage")}>
              HOME
            </button>
            {/* <button
              className={styles.button}
              onClick={() => navigate("/student_homepage/printing_configure")}
            >
              IN TÀI LIỆU
            </button> */}
            <button
              className={styles.button}
              onClick={() => navigate("/student_homepage/view_log")}
            >
              LỊCH SỬ GỬI XE
            </button>
          </div>
      ...
      <div className={styles.header_right}>
        <div className={styles.avatar_container} onClick={handleClickAvatar}>
          ...
          <div className={styles.info}>
            ...
            {showLogout && isStudent && <p className={styles.paper}>Số tiền: {money} VND</p>}
          </div>
        </div>
        {showLogout && (
